...
public class JSExecutorPractice {
    ...
    public void test1() {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver; //==> since JavaScript Executor is an interface we cast it bc we cannot create an object from interface
        for (int i = 0; i < 10; i++) {
...
//    btn1.click()
    ...
    public void test4() {
        ...
        WebElement submitButton = driver.findElement(By.name("wooden_spo" +
                "on"));
